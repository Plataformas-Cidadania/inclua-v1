cmsApp.controller('alterarDepoimentoCtrl', ['$scope', '$http', 'Upload', '$timeout', function($scope, $http, Upload, $timeout){
    ...
    $scope.detalhar = function(id){
        ...
        $http({
            ...
            $scope.depoimento = data.data;
            console.log($scope.depoimento);
            $scope.dimensoes.forEach(function (item){
                if(item.id_dimensao === $scope.depoimento.id_dimensao){
                    $scope.dimensao = item;
                }
            });
            $scope.processandoDetalhar = false;
    ...
    $scope.alterar = function (file){
        ...
        if(file==null){
            ...
            $http.put("api/depoimento/"+$scope.id, $scope.depoimento).success(function (data){
                //console.log(data);
                $scope.processandoSalvar = false;
    ...
    $scope.carregaImagem  = function(img) {
        if(img!=''){
            $scope.imagemBD = 'imagens/depoimentos/xs-'+img;
