cmsApp.controller('respostaRelateCtrl', ['$scope', '$http', 'Upload', '$timeout', function($scope, $http, Upload, $timeout){
    ...
    $scope.$watch('currentPage', function(){
        if($listar){
            $scope.listarRespostas($scope.id_pergunta);
        }
    });
    ...
    $scope.listarRespostas = function(id_pergunta){
    ...
    $scope.status = function(id_depoimento, statusAtual){
        ...
        $http.put("api/resposta_relate/"+id_depoimento, depoimentoStatus).success(function (data){
            //console.log(data);
            $scope.listarRespostas($scope.id_pergunta);
        }).error(function(data){
            console.log(data);
