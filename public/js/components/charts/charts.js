class Charts extends React.Component {
  ...
  componentWillReceiveProps(props) {
    ...
    for (let chart in data) {
      ...
      let tituloY = data[chart].titulo_colunas[1]; //let tipoGrafico = data[chart].nome_tipo_grafico === "MultiBarChart" ? "column" : data[chart].nome_tipo_grafico;
      ...
      for (let j in dataChart) {
        ...
        labels.push(dataChart[j].label.split(' ')); //labels.push("")
