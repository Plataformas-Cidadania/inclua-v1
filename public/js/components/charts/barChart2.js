class BarChart2 extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      series: [{
        data: props.data ? props.data.values : [10, 20, 30, 80, 70, 60, 50, 40] //data: props.data ? props.data.values : []
  ...
  update() {
    ...
    ApexCharts.exec(this.props.id, 'updateOptions', options); //this.setState({series: series});
  }
