    ...
    <div class="row">
        {{--@foreach($partners as $partner)
            <div class="col-xs-6 col-sm-4 col-md-2 item-logo">
                <picture>
                    <source data-src="/imagens/partners/md-{{$partner->imagem}}" media="(max-width: 468px)">
                    <source data-src="/imagens/partners/md-{{$partner->imagem}}" media="(max-width: 768px)">
                    <source data-src="/imagens/partners/md-{{$partner->imagem}}" class="img-responsive">
                    <img src="/img/pre-img.gif" data-src="/imagens/partners/md-{{$partner->imagem}}" alt="Imagem sobre {{$partner->title}}" title="Imagem sobre {{$partner->title}}" width="100%" class="cliente-list-img-hover lazyload">
                </picture>
            </div>
        @endforeach--}}
    </div>
