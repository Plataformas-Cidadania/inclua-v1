    ...
    const paginate = () => {
        ...
        if(n_pages <= 10){
            ...
            if(page<=5){
                ...
                pages.push(p[5]);
                pages.push(p[6]);
                pages.push(<li className="page-item "><a className="page-link" >...</a></li>);
        ...
        setPagination(
            <ul className="pagination">
                {/*<li className="page-item disabled" style={{display: page > 0 ? '' : 'none'}}>
                    <a className="page-link" href="#" tabIndex="-1">Anterior</a>
                </li>*/}
                {pages}
                {/*<li className="page-item" style={{display: page < parseInt(total / perPage) ? '' : 'none'}}>
