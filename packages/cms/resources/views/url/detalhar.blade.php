...
@section('content')
    {!! Html::script(config('app.url').'assets-cms/js/controllers/alterarUrlCtrl.js') !!}
    <div ng-controller="alterarUrlCtrl">
        <div class="box-padrao">
            <h1><a href="javascript:history.back();"><i class="fa fa-arrow-circle-left"></i></a>&nbsp;&nbsp;Urls</h1>
            <?php //print_r($url);?>
            <div ng-init="carregaImagem('{{$url->imagem}}', '{{$url->arquivo}}')">
                <span class="texto-obrigatorio">* campos obrigatórios</span><br><br>
                {!! Form::model($url, ['name' =>'form']) !!}
                ...
                <a href="arquivos/urls/<% arquivoBD %>" target="_blank" ng-show="arquivoBD"><% arquivoBD %></a>
                <a ng-show="fileArquivo"><% fileArquivo.name %></a>
                <br><br>

                <br><br>
                @include('cms::url._form')
                <input type="hidden" name="id" ng-model="id" ng-init="id='{{$url->id}}'"/>
                <div class="row">
