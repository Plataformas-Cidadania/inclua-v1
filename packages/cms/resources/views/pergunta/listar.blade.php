...
@section('content')
    {!! Html::script(config('app.url').'assets-cms/js/controllers/perguntaCtrl.js') !!}
<script>
    $(function () {
                           ...
                           {{-- <td><img ng-show="pergunta.imagem" ng-src="imagens/perguntas/xs-<% pergunta.imagem %>" width="60"></td>--}}
                            ...
                            <td class="text-right">
                                <div>
                                    ...
                                    <a><i data-toggle="modal" data-target="#modalExcluir" class="fa fa-remove fa-2x" ng-click="perguntaExcluir(pergunta.id_pergunta, pergunta.titulo, pergunta.imagem)"></i></a>
                                </div>
                            </td>
                        </tr>
                        </tbody>
