...
@section('content')
    {!! Html::script(config('app.url').'assets-cms/js/controllers/alterarCuradoriaCtrl.js') !!}
    <div ng-controller="alterarCuradoriaCtrl">
        <div class="box-padrao">
            <h1><a href="javascript:history.back();"><i class="fa fa-arrow-circle-left"></i></a>&nbsp;&nbsp;Curadoria</h1>
            <?php //print_r($curadoria);?>
            <div ng-init="carregaImagem('{{$curadoria->imagem}}', '{{$curadoria->arquivo}}'); id_curadoria={{$curadoria->id_curadoria}};">
                <span class="texto-obrigatorio">* campos obrigatórios</span><br><br>
                {!! Form::model($curadoria, ['name' =>'form']) !!}
                ...
                <a href="arquivos/curadorias/<% arquivoBD %>" target="_blank" ng-show="arquivoBD"><% arquivoBD %></a>
                <a ng-show="fileArquivo"><% fileArquivo.name %></a>
                {{--<br><br>--}}

                <br><br>
                @include('cms::curadoria._form')
                <input type="hidden" name="id" ng-model="id" ng-init="id='{{$curadoria->id_curadoria}}'"/>
                <div class="row">
                    <div class="col-md-1 col-lg-1 col-xs-3">
                        <br>
                        <button class="btn btn-info" type="button" ng-click="alterar(picFile, fileArquivo)" ng-disabled="form.$invalid && form.curadoria.$dirty">Salvar</button>
                    </div>
