...
@section('content')
    {!! Html::script(config('app.url').'assets-cms/js/controllers/dimensaoCtrl.js') !!}
<script>
    $(function () {
        $('[data-toggle="popover"]').popover()
    })
</script>
    <div ng-controller="dimensaoCtrl">
        <div class="box-padrao">
            <h1><i class="fa fa-dimensao" aria-hidden="true"></i>&nbsp;Dimensões</h1>
                           ...
                           {{-- <td><img ng-show="dimensao.imagem" ng-src="imagens/dimensoes/xs-<% dimensao.imagem %>" width="60"></td>--}}
                            ...
                            <td class="text-right">
                                <div>
                                    ...
                                    <a href="cms/indicadores/<% dimensao.id_dimensao %>"><i class="fa fa-tachometer fa-2x" title="Indicadores"></i></a>&nbsp;&nbsp;{{--<% mensagemStatus %><% idStatus %>--}}
