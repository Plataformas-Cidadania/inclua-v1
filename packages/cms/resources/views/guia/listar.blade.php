...
@section('content')
    {!! Html::script(config('app.url').'assets-cms/js/controllers/guiaCtrl.js') !!}
<script>
    $(function () {
        $('[data-toggle="popover"]').popover()
    })
</script>
    <div ng-controller="guiaCtrl">
        <div class="box-padrao">
            <h1><i class="fa fa-guia" aria-hidden="true"></i>&nbsp;Guias</h1>
            <button class="btn btn-primary" ng-click="mostrarForm=!mostrarForm" ng-show="!mostrarForm">Novo Guia</button>
            ...
            <div class="col-md-12">
                <div class="box-padrao">
                    ...
                    <table ng-show="totalItens>0" class="table table-striped">
                        <thead>
                        <tr>
                            <th ng-click="ordernarPor('id')" style="guiar:pointer;">
                                Id
                            ...
                            <th>Imagem</th>
                            <th ng-click="ordernarPor('guia')" style="guiar:pointer;">
                                Guia
                                <i ng-if="ordem=='guia' && sentidoOrdem=='asc'" class="fa fa-angle-double-down"></i>
                                <i ng-if="ordem=='guia' && sentidoOrdem=='desc'" class="fa fa-angle-double-up"></i>
                            </th>
                            <th></th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr ng-repeat="guia in guias">
                            <td><% guia.id %></td>
                            <td><img ng-show="guia.imagem" ng-src="imagens/guias/xs-<% guia.imagem %>" width="60"></td>
                            <td><a href="cms/guia/<% guia.id %>"><% guia.titulo %></a></td>
                            <td class="text-right">
                                <div>
                                    <a href="cms/guia/<% guia.id %>"><i class="fa fa-edit fa-2x" title="Editar"></i></a>&nbsp;&nbsp;
                                    <a  ng-class="<% guia.status %> == 1 ? 'color-success' : 'color-success-inactive'"  style="cursor: pointer;"><i class="fa fa-check-circle fa-2x" aria-hidden="true" ng-click="status(guia.id);"></i></a>
                                    <a><i data-toggle="modal" data-target="#modalExcluir" class="fa fa-remove fa-2x" ng-click="perguntaExcluir(guia.id, guia.titulo, guia.imagem)"></i></a>
                                </div>
                            </td>
                        </tr>
                        </tbody>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-3">
                                <img  ng-src="imagens/guias/xs-<% imagemExcluir %>" width="100">
                            </div>
                            <div class="col-md-9">
                                <p><% tituloExcluir %></p>
                            </div>
