...
@section('content')
    {!! Html::script(config('app.url').'assets-cms/js/controllers/alterarGuiaCtrl.js') !!}
    <div ng-controller="alterarGuiaCtrl">
        <div class="box-padrao">
            <h1><a href="javascript:history.back();"><i class="fa fa-arrow-circle-left"></i></a>&nbsp;&nbsp;Guias</h1>
            <?php //print_r($guia);?>
            <div ng-init="carregaImagem('{{$guia->imagem}}', '{{$guia->arquivo}}')">
                <span class="texto-obrigatorio">* campos obrigatórios</span><br><br>
                {!! Form::model($guia, ['name' =>'form']) !!}
                ...
                <a href="arquivos/guias/<% arquivoBD %>" target="_blank" ng-show="arquivoBD"><% arquivoBD %></a>
                <a ng-show="fileArquivo"><% fileArquivo.name %></a>
                <br><br>

                <br><br>
                @include('cms::guia._form')
                <input type="hidden" name="id" ng-model="id" ng-init="id='{{$guia->id}}'"/>
                <div class="row">
                    <div class="col-md-1 col-lg-1 col-xs-3">
                        <button class="btn btn-info" type="button" ng-click="alterar(picFile, fileArquivo)" ng-disabled="form.$invalid && form.guia.$dirty">Salvar</button>
                    </div>
