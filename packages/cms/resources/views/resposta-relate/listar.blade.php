...
@section('content')
    {!! Html::script(config('app.url').'assets-cms/js/controllers/respostaRelateCtrl.js') !!}
<script>
    $(function () {
                ...
                <div class="box-padrao">
                    ...
                    <table ng-show="totalItens>0" class="table table-striped">
                        ...
                        <tr ng-repeat="resposta in respostas">
                           ...
                           {{-- <td><img ng-show="resposta.imagem" ng-src="imagens/respostas/xs-<% resposta.imagem %>" width="60"></td>--}}
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            {{--<div class="col-md-3">
                                <img  ng-src="imagens/respostas/xs-<% imagemExcluir %>" width="100">
                            </div>--}}
                            <div class="col-md-9">
                                <p><% tituloExcluir %></p>
                            </div>
