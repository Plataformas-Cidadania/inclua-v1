...
@section('content')
    {!! Html::script(config('app.url').'assets-cms/js/controllers/curadorCtrl.js') !!}
<script>
    $(function () {
        $('[data-toggle="popover"]').popover()
    })
</script>
    <div ng-controller="curadorCtrl">
        <div class="box-padrao">
            <h1><i class="fa fa-curador" aria-hidden="true"></i>&nbsp;Curadores</h1>
            <button class="btn btn-primary" ng-click="mostrarForm=!mostrarForm" ng-show="!mostrarForm">Novo Curador</button>
            ...
            <div class="col-md-12">
                <div class="box-padrao">
                    ...
                    <table ng-show="totalItens>0" class="table table-striped">
                        ...
                        <tbody>
                        <tr ng-repeat="curador in curadores">
                            <td><% curador.id_curador %></td>
                           {{-- <td><img ng-show="curador.imagem" ng-src="imagens/curadores/xs-<% curador.imagem %>" width="60"></td>--}}
                            <td><% curador.nome %></td>
                            <td class="text-right">
                                <div>
                                    {{--<a href="cms/items/<% curador.id %>"><i class="fa fa-sitemap fa-2x" title="Itens"></i></a>&nbsp;&nbsp;--}}
                                    <a href="cms/curador/<% curador.id_curador %>"><i class="fa fa-edit fa-2x" title="Editar"></i></a>&nbsp;&nbsp;{{--<% mensagemStatus %><% idStatus %>--}}
                                    {{--<a  ng-class="<% curador.status %> == 1 ? 'color-success' : 'color-success-inactive'"  style="cursor: pointer;"><i class="fa fa-check-circle fa-2x" aria-hidden="true" ng-click="status(curador.id);"></i></a>&nbsp;&nbsp;--}}
                                    <a><i data-toggle="modal" data-target="#modalExcluir" class="fa fa-remove fa-2x" ng-click="perguntaExcluir(curador.id_curador, curador.nome, curador.imagem)"></i></a>
                                </div>
                            </td>
                        </tr>
                        </tbody>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            {{--<div class="col-md-3">
                                <img  ng-src="imagens/curadores/xs-<% imagemExcluir %>" width="100">
                            </div>--}}
                            <div class="col-md-9">
                                <p><% tituloExcluir %></p>
                            </div>
