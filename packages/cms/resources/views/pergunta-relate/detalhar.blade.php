...
@section('content')
    {!! Html::script(config('app.url').'assets-cms/js/controllers/alterarPerguntaRelateCtrl.js') !!}
    <div ng-controller="alterarPerguntaRelateCtrl">
        <div class="box-padrao">
            <h1><a href="javascript:history.back();"><i class="fa fa-arrow-circle-left"></i></a>&nbsp;&nbsp;Pergunta</h1>
            <?php //print_r($pergunta);?>
            <div ng-init="carregaImagem('{{$pergunta->imagem}}', '{{$pergunta->arquivo}}'); detalhar({{$pergunta->id_pergunta}})">
