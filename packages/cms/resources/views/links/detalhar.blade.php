...
@section('content')
    ...
    <div ng-controller="alterarLinkCtrl">
        <div class="box-padrao">
            <h1><a href="javascript:history.back();"><i class="fa fa-arrow-circle-left"></i></a>&nbsp;&nbsp;Link</h1>
            <?php //print_r($link);?>
            <div ng-init="carregaImagem('{{$link->imagem}}', '{{$link->arquivo}}'); detalhar({{$link->id_link}})">
                ...
                <input type="hidden" name="id" ng-model="id" ng-init="id='{{$link->id_link}}'"/>
                <div class="row">
                    <div class="col-md-1 col-lg-1 col-xs-3">
                        <br>
                        <button class="btn btn-info" type="button" ng-click="alterar(picFile, fileArquivo)" ng-disabled="form.$invalid && form.link.$dirty">Salvar</button>
                    </div>
