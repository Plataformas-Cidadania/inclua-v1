...
@section('content')
    {!! Html::script(config('app.url').'assets-cms/js/controllers/userCtrl.js') !!}
<script>
    $(function () {
    ...
    <div ng-controller="userCtrl">
        <div class="box-padrao">
            <h1><i class="fa fa-fw fa-users"></i>&nbsp;Usuários Site</h1>
            ...
            <div ng-show="mostrarForm">
                ...
                <div class="row">
                    <div class="col-md-1 col-lg-1 col-xs-3">
                        <button class="btn btn-info" type="button" ng-click="inserir(picFile)" ng-disabled="form.$invalid || user.password!=user.confpassword">Salvar</button>
                    </div>
            ...
            <div class="col-md-12">
                <div class="box-padrao">
                    ...
                    <table ng-show="totalItens>0" class="table table-striped">
                        <thead>
                        <tr>
                            <th ng-click="ordernarPor('id')" style="userr:pointer;">
                                Id
                            ...
                            <th>Nome</th>
                            <th ng-click="ordernarPor('user')" style="userr:pointer;">
                                E-mail
                                <i ng-if="ordem=='user' && sentidoOrdem=='asc'" class="fa fa-angle-double-down"></i>
                                <i ng-if="ordem=='user' && sentidoOrdem=='desc'" class="fa fa-angle-double-up"></i>
                            </th>
                            <th></th>
                        </tr>
                        </thead>
                        ...
                        <tr ng-repeat="user in users">
                            <td><% user.id %></td>
                            <td><a href="cms/usuario/<% user.id %>"><% user.name %></a></td>
                            <td><% user.email %></td>
                            <td class="text-right">
                                <div>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-3">
                                <img  ng-src="imagens/users/<% imagemExcluir %>" width="100">
                            </div>
                            <div class="col-md-9">
                                <p><% tituloExcluir %></p>
                            </div>
