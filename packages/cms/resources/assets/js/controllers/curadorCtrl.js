cmsApp.controller('curadorCtrl', ['$scope', '$http', 'Upload', '$timeout', function($scope, $http, Upload, $timeout){
    ...
    var listarCuradores = function(){
        ...
        $http({
            ...
            let numeroMaximo = Math.max.apply(Math, $scope.curadores.map(function(item) { return item.numero; }));
            $scope.curador.numero = numeroMaximo + 1;
    ...
    $scope.inserir = function (file, arquivo){
        ...
        if(file==null && arquivo==null){
            ...
            curador.file = file;
            curador.arquivo = arquivo;
            Upload.upload({
                url: 'api/curador',
                data: curador,
                //data: {curador: $scope.curador, file: file, arquivo: arquivo},
