cmsApp.controller('guiaCtrl', ['$scope', '$http', 'Upload', '$timeout', function($scope, $http, Upload, $timeout){
    ...
    var listarGuias = function(){
        $scope.processandoListagem = true;
        $http({
            url: 'cms/listar-guias',
            method: 'GET',
            params: {
    ...
    $scope.inserir = function (file, arquivo){
        ...
        if(file==null && arquivo==null){
            ...
            $http.post("cms/inserir-guia", {guia: $scope.guia}).success(function (data){
                 listarGuias();
                 delete $scope.guia;//limpa o form
            ...
            Upload.upload({
                url: 'cms/inserir-guia',
                data: {guia: $scope.guia, file: file, arquivo: arquivo},
