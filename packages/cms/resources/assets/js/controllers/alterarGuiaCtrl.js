cmsApp.controller('alterarGuiaCtrl', ['$scope', '$http', 'Upload', '$timeout', function($scope, $http, Upload, $timeout){
    ...
    $scope.alterar = function (file, arquivo){
        ...
        if(file==null && arquivo==null){
            ...
            $http.post("cms/alterar-guia/"+$scope.id, {
                'guia': $scope.guia,
            ...
            Upload.upload({
                ...
                $scope.mensagemSalvar =  "Gravado com sucesso!";
                $scope.removerImagem = false;
                $scope.imagemBD = '/imagens/guias/'+response.data;
                $scope.processandoSalvar = false;
    ...
    $scope.carregaImagem  = function(img, arquivo) {
        if(img!=''){
            $scope.imagemBD = 'imagens/guias/xs-'+img;
